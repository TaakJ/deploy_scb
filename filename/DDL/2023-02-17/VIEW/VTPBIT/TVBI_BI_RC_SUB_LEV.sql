CREATE OR REPLACE VIEW P1VTPBIT.TVBI_BI_RC_SUB_LEV (
  PARTY_ID,
  RC,
  RC_NAME_EN,
  RC_NAME_TH,
...
,F.ORGANIZATION_NUM  AS RC
, C.ORG_NAME_EN AS RC_NAME_EN
, C.ORG_NAME_TH AS RC_NAME_TH
, C.ORG_NAME_DESC_EN AS RC_NAME_DESC_EN
, C.ORG_NAME_DESC_TH AS RC_NAME_DESC_TH
...
(
 ...
 INNER JOIN P1VUTEDW.BKEY_PARTY AS P
 ON F.INTERNAL_ORG_PARTY_ID = P.EDW_KEY
  AND SUBSTR(P.SOURCE_KEY,0,INSTR(P.SOURCE_KEY,'_')-1) = '0000000000000000061020'
...
ON A.PARENT_SEGMENT_VALUE = F.ORGANIZATION_NUM
  ...
  AND A.COA_SEGMENT_CATEGORY_CD = 2
