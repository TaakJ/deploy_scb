CREATE OR REPLACE VIEW P1VTXEDW.VESL_EDW_ACCT_STATS_IM (
  As_Of_Dt,
  Account_Num,
...
AS SELECT 
 ...
 ,CASE WHEN SUMD_BANK_BALANCE_AMT_BAHT_DD > 0 
   ...
   ELSE 0 END 
   AS AVGD_BANK_BALANCE_AMT_BAHT_DD
   FROM 
  (
      ...
      ,BD.Days_Num
       ,MIN(CASE WHEN  BAL.FUND_IND = 'F' 
                    THEN ABS(COALESCE(BAL.BANK_BALANCE_AMT_DD, 0 )) 
                     ELSE 0  END)
       ...
       ,MIN(CASE WHEN  BAL.FUND_IND = 'F' 
                      THEN ABS(COALESCE(BAL.BANK_BALANCE_AMT_BAHT_DD, 0 )) 
                      ELSE 0 END)
       ...
       ,MIN(CASE WHEN  BAL.FUND_IND = 'D' 
                    THEN ABS(COALESCE(BAL.BANK_BALANCE_AMT_DD, 0 )) 
                     ELSE 0  END)
                 AS MIND_BANK_BALANCE_AMT_DD
        ,MAX( CASE WHEN  BAL.FUND_IND = 'D' 
           THEN ABS(COALESCE(BAL.BANK_BALANCE_AMT_DD, 0 )) 
           ELSE 0 END)
          AS MAXD_BANK_BALANCE_AMT_DD
        ,SUM(CASE WHEN  BAL.FUND_IND = 'D' 
          THEN ABS(COALESCE(BAL.BANK_BALANCE_AMT_DD, 0 )) 
          ELSE 0 END)
         AS SUMD_BANK_BALANCE_AMT_DD
       ,MIN(CASE WHEN  BAL.FUND_IND = 'D' 
                      THEN ABS(COALESCE(BAL.BANK_BALANCE_AMT_BAHT_DD, 0 )) 
                      ELSE 0 END)
        AS MIND_BANK_BALANCE_AMT_BAHT_DD
       ,MAX(CASE WHEN  BAL.FUND_IND = 'D' 
                      THEN ABS(COALESCE(BAL.BANK_BALANCE_AMT_BAHT_DD, 0 )) 
                      ELSE 0 END)
         AS MAXD_BANK_BALANCE_AMT_BAHT_DD
       ,SUM     (CASE WHEN  BAL.FUND_IND = 'D' 
                           THEN ABS(COALESCE(BAL.BANK_BALANCE_AMT_BAHT_DD, 0 )) 
                           ELSE 0 END) 
        AS SUMD_BANK_BALANCE_AMT_BAHT_DD
