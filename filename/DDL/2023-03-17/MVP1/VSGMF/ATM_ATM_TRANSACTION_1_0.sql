CREATE OR REPLACE VIEW P1VSGMF.ATM_ATM_TRANSACTION_1_0 (
  EDW_RECORD_NO,
  DAT_TIM,
  REC_TYP,
  AUTH_PPD,
...
,AUTHX_TRAN_TIM_HMS
,AUTHX_TRAN_TIM_TT
,COALESCE(CDT2.DEFAULT_DATE,to_date('1000-01-02','yyyy-MM-dd')) AS AUTHX_POST_DAT_YMD /*D2*/
,COALESCE(CDT3.DEFAULT_DATE,to_date('1000-01-02','yyyy-MM-dd')) AS ACQ_ICHG_SETL_DAT_YMD /*D3*/
,COALESCE(CDT4.DEFAULT_DATE,to_date('1000-01-02','yyyy-MM-dd')) AS ISS_ICHG_SELT_DAT_YMD /*D4*/
,SEQ_NUM
,TERM_TYP
,TIM_OFST
,REFERENCE_NO_1
...
FROM	 p1dsgedw.ATM_ATM_TRANSACTION_1_0_T1   AS   T1
