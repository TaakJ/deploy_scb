CREATE OR REPLACE VIEW P1VSGMF.B2MTX_MF2ECOM1_T_ND_1_0 (
  EDW_RECORD_NO,
  LOG_REPORT_TYPE,
...
STGMERGE.LOG_REPORT_TRAN_TYPE AS BM_M12950_002,
STGMERGE.LOG_REPORT_POS_ENTRY AS BM_M44477_002,
COALESCE(STGMERGE.LOG_RPT_GENR_TYPE_2, '  ') AS LOG_RPT_GENR_TYPE_2,
...
(
 ...
 FROM p1dsgedw.B2MTX_MF2ECOM1_T_ND_1_0_T1
) STGMERGE
