CREATE OR REPLACE VIEW P1VSGMF.ATM_CDM_R_TRANSAC_1_0 (
  edw_record_no,
  DAT_TIM,
  REC_TYP,
  AUTH_PPD,
...
,COALESCE(CC.DEFAULT_DATE,to_date('1000-01-02','yyyy-MM-dd')) AS AUTHX_TRAN_DAT_YMD /*D1*/
...
,STGMERGE.TLF_CHANGE_ACCT
,STGMERGE.TLF_CHANGE_ACCT_BR
,STGMERGE.TLF_CHANGE_ACCT_TY
,STGMERGE.TLF_CHANGE_AMT
,STGMERGE.TLF_FILLER
,STGMERGE.ORIG_CRNCY_CDE
,STGMERGE.FROM_BANK_CODE
,STGMERGE.TO_BANK_CODE
,STGMERGE.CDM_BILL_CNT_20
,STGMERGE.CDM_BILL_CNT_100
,STGMERGE.CDM_BILL_CNT_500
,STGMERGE.CDM_BILL_CNT_1000
...
/* START CODE UR PROMPT PAY BILL PAYMENT - BALA */
,VTM_HOPR1_AMT_0100
,VTM_HOPR2_AMT_0500
,VTM_HOPR3_AMT_1000
,VTM_HOPR4_AMT_0020
...
,RTP_REFERENCE_NO
,PROMPTPAY_BILLPAY_NORM_FLAG
/* END CODE UR PROMPT PAY BILL PAYMENT - BALA */
/* CODE ADDED FOR UR PP62020001-02 KESSANEE*/
,TYPE_OF_SENDER
,TYPE_OF_RECIEVER
/* CODE ADDED FOR UR PP62020001-02 KESSANEE*/

FROM	p1dsgedw.ATM_CDM_R_TRANSAC_1_0_T1   AS   T1
